...
#define WLAN_SSID       "Bramletts_Guest"        // cannot be longer than 32 characters!
#define WLAN_PASS       "bramletts.com"
...
unsigned long getTime(void) {
  ...
  if(cc3000.getHostByName("pool.ntp.org", &ip)) {
    static const char PROGMEM
      timeReqA[] = { 128, 138, 140, 44 },//128.138.140.44
      timeReqB[] = { 132, 163, 4,  101 };//132.163.4.101
